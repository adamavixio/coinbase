...
type Order struct {
	...
	dValue      string `json:"executed_value,omitempty" bson:"executed_value,omitempty"`
...
func GetOrders(getOrders *GetOrdersConfig) ([]*Order, error) {
...
func CancelOrders(cancelOrders *CancelOrdersConfig) ([]string, error) {
...
func CreateOrder(createOrder *CreateOrderConfig) (*Order, error) {
...
func GetOrder(getOrder *GetOrderConfig) (*Order, error) {
